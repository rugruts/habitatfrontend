-- Habitat Lobby Admin Dashboard - Security Policies
-- Run this AFTER supabase-admin-schema.sql to set up proper RLS policies
...
-- Update RLS policies for admin tables to use the admin check function
